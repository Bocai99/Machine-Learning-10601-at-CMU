...
i=1;
for i=1:7
param_grad{i}.w = param_grad{i}.w+weight_decay*params{i}.w;
%param_grad{1}.b = param_grad{1}.b+weight_decay*params{1}.b;

param_winc{i}.w = mu*param_winc{i}.w + rate*param_grad{i}.w;
